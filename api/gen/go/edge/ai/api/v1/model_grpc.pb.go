...
const (
	ModelService_CreateModel_FullMethodName = "/edge.ai.api.v1.ModelService/CreateModel"
	ModelService_GetModel_FullMethodName    = "/edge.ai.api.v1.ModelService/GetModel"
	ModelService_ListModels_FullMethodName  = "/edge.ai.api.v1.ModelService/ListModels"
)
...
//
// ModelService manages model metadata in the registry.
...
var ModelService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "edge.ai.api.v1.ModelService",
	...
	Metadata: "edge/ai/api/v1/model.proto",
}
